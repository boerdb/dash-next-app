  ...
  return (
    ...
    >
      <div className="relative z-10 text-center [text-shadow:0_1px_8px_rgba(0,0,0,0.6)]">
        ...
        <div className="mx-auto mt-4 flex max-w-md flex-wrap items-center justify-center gap-x-4 gap-y-1 rounded-2xl border border-white/20 bg-black/40 px-4 py-2.5 text-sm text-white/95 backdrop-blur-sm">
          {showWindChill ? (
            <span>
              Gevoel{" "}
