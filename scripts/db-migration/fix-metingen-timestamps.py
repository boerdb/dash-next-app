#!/usr/bin/env python3
"""UTC meet_moment (+2h) voor rijen die Next na 14:20 per ongeluk in UTC schreef."""
import sys
...
sql = """
UPDATE metingen
SET meet_moment = DATE_ADD(meet_moment, INTERVAL 2 HOUR)
WHERE meet_moment >= '2026-05-22 14:20:00'
  AND meet_moment < '2026-05-22 15:00:00';
SELECT meet_moment, temp_c FROM metingen
WHERE DATE(meet_moment) = CURDATE()
ORDER BY meet_moment DESC LIMIT 6;
"""
